...
class HPTuning:
    ...
    def _prepare_data(self, model_name) -> HPTuningData:
        self._ds_manager.get_TrainDfs(model_name)
        hp_tining_data = HPTuningData.load_from_ds_manager_subset(data_subset=self._ds_manager.data_subsets[model_name],
                                                                  )
    ...
    def _load_model_from_config(self, model_name: str, hp_tuning_data):
        ...
        model_config = self._ds_manager._prepare_datasets[model_name]._model_config
