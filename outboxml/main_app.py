...
from outboxml.core.pydantic_models import UpdateRequest
...
async def update_route(update_request: UpdateRequest):
    ...
    try:
        ...
        if auto_ml_config is not None and all_model_config is not None:

           auto_ml  = AutoMLManager(auto_ml_config=all_model_config,
